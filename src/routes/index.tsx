...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Best Catering Services in Chennai | Wedding, Corporate & Event Catering" },
      {
        name: "description",
        content:
          "Looking for the best catering services in Chennai? My Chennai Catering provides premium wedding, corporate, birthday and event catering with customized menus.",
      },
      {
        name: "robots",
      ...
      {
        property: "og:title",
        content: "Premium Catering Services in Chennai"
      },
      {
      ...
      { property: "og:url", content: "https://cateringinchennai.com/" },
      ...
      {
        name: "twitter:title",
        content: "Best Catering Services in Chennai"
      },
      {
    ...
    links: [{ rel: "canonical", href: "https://cateringinchennai.com/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "WebSite",
              "@id": "https://cateringinchennai.com/#website",
              "url": "https://cateringinchennai.com/",
              "name": "My Chennai Catering",
              "description": "Premium wedding, corporate, and event catering services in Chennai.",
              "potentialAction": {
                "@type": "SearchAction",
                "target": "https://cateringinchennai.com/search?q={search_term_string}",
                "query-input": "required name=search_term_string"
              }
            },
            {
              "@type": "Organization",
              "@id": "https://cateringinchennai.com/#organization",
              "name": "My Chennai Catering",
              "alternateName": "MCC Catering",
              "url": "https://cateringinchennai.com/",
              "logo": "https://cateringinchennai.com/logo.png",
              "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "+91-9940396005",
                "contactType": "customer service",
                "areaServed": "IN",
                "availableLanguage": ["en", "ta"]
              },
              "sameAs": [
                "https://www.facebook.com/mychennaicatering",
                "https://www.instagram.com/mychennaicatering"
              ]
            },
            {
              "@type": "LocalBusiness",
              ...
              "name": "My Chennai Catering",
              "image": "https://cateringinchennai.com/logo.png",
              "telephone": "+919940396005",
              "url": "https://cateringinchennai.com/",
              "address": {
                "@type": "PostalAddress",
                "streetAddress": "No 49, South Bazaar, Thandurai, Pattabiram",
            ...
            },
            {
              ...
              "@id": "https://cateringinchennai.com/#cateringservice",
              "name": "My Chennai Catering Services",
              "provider": { "@id": "https://cateringinchennai.com/#localbusiness" },
              "areaServed": [
                "Chennai",
                "Pattabiram",
                "Avadi",
            ...
            {
              "@type": "BreadcrumbList",
              "@id": "https://cateringinchennai.com/#breadcrumb",
              "itemListElement": [
                {
                  "@type": "ListItem",
                  "position": 1,
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <img
                  ...
                  alt={`${HERO_SLIDES[currentSlide].title} - My Chennai Catering Services`}
